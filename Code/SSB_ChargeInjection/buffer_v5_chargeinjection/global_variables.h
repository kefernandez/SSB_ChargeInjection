...
extern float Vc3_min_V;
extern float Vc3_min_hold_V;
extern float Vc3_prev_V;
extern float Vc3_rip_V;
extern float Vc3_avg_V;
...
extern float duty_min_off;
extern float duty_ci_min;
extern float duty_ci_max;
