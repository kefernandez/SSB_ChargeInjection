...
float gain_dac = 1;
float adc_scale_c1 = 0.99;
float adc_scale_c2 = 1.01;
float duty_test = 0.5;
...
// PI controller
float32 Kp_pll = 0.5; // 0.75; //0.012939691768802;
float32 Ki_pll = 1e-5; //1.437966465082929e-05; //1.437966465082929e-05;
float32 x_sum_pll = 0;
