...
#define VC1_ADC_MAX_VOLT        526.75 //57.75 //156.45 for 44.2k        // Expected maximum full voltage value (corresponds to full ADC counts, 4096, without bias compensation)
